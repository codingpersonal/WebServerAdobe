...
public class HttpResponse {
	...
	public HttpResponse formHttpResponse() {
		if(outFile == null) {
			...
			statusCode = HttpStatusCodes.STATUS_400;
			return sendHttpErrorResponse(errorStr);
		} else {
			if(outFile.isFile()) {
				statusCode = HttpStatusCodes.STATUS_SUCCESS;
				...
				statusCode = HttpStatusCodes.STATUS_404;
				return sendHttpErrorResponse(errorStr);
			}
	...
	public String toString() {
		String responseStr = HttpConstants.HTTP_Protocol_Version + " " + statusCode +"\n";
